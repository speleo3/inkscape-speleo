...
def parse_scrap(a: Sequence[str]):
    ...
    if not th2pref.scale_real_m_per_th2_desc and len(e) > 0:
        th2pref.scale_real_m_per_th2_desc = f"{scrap_source} (<undefined>)"
        errormsg(f"`-scale` undefined for {scrap_source}, can't set scale.")
